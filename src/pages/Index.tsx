...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden font-['Segoe_UI',-apple-system,BlinkMacSystemFont,'Helvetica_Neue',Helvetica,Arial,sans-serif]">
            ...
            <div className="w-full lg:translate-x-8 xl:translate-x-12 lg:max-w-[100%] relative px-4 lg:px-0">
              ...
              <div className="relative w-full max-w-xl mx-auto lg:ml-0 transform lg:scale-90 font-league-spartan">
                <div className="glass-card rounded-lg overflow-visible shadow-2xl">
                  ...
                  {/* Chat Body - with individual fade-in animations - removed scrolling */}
      ...
      {/* New "AI is changing communication" section - replaced em dashes with hyphens */}
            ...
            <div className="space-y-6 md:space-y-12">
              ...
              <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-6">
                ...
                <div className="md:flex-1">
                  ...
                  {/* @genie mention infographic - updated with Slack color code */}
